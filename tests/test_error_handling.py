...
class TestErrorHandling(unittest.TestCase):
    ...
    @patch('graph.Crew')
    def test_recruit_node_double_failure(self, mock_crew, mock_recruiter, mock_task):
        # Simulate double failure (primary and fallback)
        mock_crew_instance = MagicMock()
        mock_crew.return_value = mock_crew_instance
        # Primary fail
        # Fallback fail
        mock_crew_instance.kickoff.side_effect = [Exception("RateLimit Primary"), Exception("RateLimit Fallback")]
    ...
    @patch('graph.Crew')
    def test_hypothesis_node_double_failure(self, mock_crew, mock_create, mock_task):
        mock_crew_instance = MagicMock()
        mock_crew.return_value = mock_crew_instance
        mock_crew_instance.kickoff.side_effect = [Exception("RateLimit"), Exception("RateLimit Fallback")]
    ...
    @patch('graph.Crew')
    def test_debate_node_double_failure(self, mock_crew, mock_da, mock_task):
        mock_crew_instance = MagicMock()
        mock_crew.return_value = mock_crew_instance
        mock_crew_instance.kickoff.side_effect = [Exception("RateLimit"), Exception("RateLimit Fallback")]
    ...
    @patch('graph.Crew')
    def test_synthesis_node_double_failure(self, mock_crew, mock_synth, mock_task):
        mock_crew_instance = MagicMock()
        mock_crew.return_value = mock_crew_instance
        mock_crew_instance.kickoff.side_effect = [Exception("RateLimit"), Exception("RateLimit Fallback")]
